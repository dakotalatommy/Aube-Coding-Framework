...
def _make_idempotency_key(tenant_id: str, obj_type: str, attrs: Dict[str, Any], provided: str | None) -> str:
    if provided:
        return provided
...
def upsert(tenant_id: str, obj_type: str, attrs: Dict[str, Any], idempotency_key: str | None = None) -> Dict[str, Any]:
